...
struct JavaGUI_ctxt: ctxTag="AndroidGUI" Platform='Java' Lang='Java' LibReq="AndroidGUI" implMode="inherit:Activity" {
...
struct GUI_ctxt: ctxTag="AndroidGUI" Platform='Java' Lang='Java' LibReq="AndroidGUI" implMode="inherit:Activity" {
