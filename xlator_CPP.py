...
def iterateContainerStr(classes,localVarsAlloc,containerType,repName,repContainer,datastructID,keyFieldType,containerOwner, isBackward, actionOrField, indent, genericArgs,xlator):
...
def codeNewVarStr(classes, lhsTypeSpec, varName, fieldDef, indent, objsRefed, actionOrField, genericArgs, xlator):
    [fieldType, innerType] = convertType(classes, lhsTypeSpec, 'var', '', genericArgs, xlator)
    varDeclareStr=''
    assignValue=''
