...
nameAndVal = (Literal(":") + CID + Literal("(") + argList + Literal(")") + Literal("=") + Literal("(") + (value | funcBody ) + Literal(")")) | (Literal(":=") + Literal("(") + (value | funcBody) + Literal(")")) | (Literal(":") + CID + Literal("(") + argList + Literal(")"))("nameAndVal")
#flagName = CID("flagName")
modeSpec = Group(Optional(Keyword("my") | Keyword("me")) + Keyword("flag") + nameAndVal )("modeSpec")
flagDef = Group(Optional(Keyword("my") | Keyword("me")) + Keyword("flag") + nameAndVal )("flagDef")
...
fieldDefs = Forward()
coFactualEL  = Literal("(") + Group(fieldDefs + Literal("<=>") + Group(OneOrMore(SetFieldStmt + Literal(';').suppress())))  + Literal(")") ("coFactualEL")
...
fullFieldDef = (Literal('>') + CID + Literal('(') + (baseType | objectName | anonModel) + Literal(')') + Literal('[') + Literal(']'))("fullFieldDef")
fieldDef = (flagDef | modeSpec | quotedString | intNum | nameAndVal | fullFieldDef)("fieldDef")
fieldDefs <<=  Literal("{").suppress() + Group(ZeroOrMore(fieldDef))+ Literal("}").suppress()("fieldDefs")
